...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodePSIStrategy) DeepCopyInto(out *NodePSIStrategy) {
	*out = *in
	in.NodeCfgProfile.DeepCopyInto(&out.NodeCfgProfile)
	if in.PSIStrategy != nil {
		in, out := &in.PSIStrategy, &out.PSIStrategy
		*out = new(v1alpha1.PSIStrategy)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodePSIStrategy.
func (in *NodePSIStrategy) DeepCopy() *NodePSIStrategy {
	if in == nil {
		return nil
	}
	out := new(NodePSIStrategy)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PSICfg) DeepCopyInto(out *PSICfg) {
	*out = *in
	if in.ClusterStrategy != nil {
		in, out := &in.ClusterStrategy, &out.ClusterStrategy
		*out = new(v1alpha1.PSIStrategy)
	...
	if in.NodeStrategies != nil {
		in, out := &in.NodeStrategies, &out.NodeStrategies
		*out = make([]NodePSIStrategy, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PSICfg.
func (in *PSICfg) DeepCopy() *PSICfg {
	if in == nil {
		return nil
	}
	out := new(PSICfg)
