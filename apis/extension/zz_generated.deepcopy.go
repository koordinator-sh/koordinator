...
func (in *ColocationStrategy) DeepCopyInto(out *ColocationStrategy) {
	*out = *in
	...
	in.ProdOvercommitStrategy.DeepCopyInto(&out.ProdOvercommitStrategy)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProdOvercommitStrategy) DeepCopyInto(out *ProdOvercommitStrategy) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProdOvercommitStrategy.
func (in *ProdOvercommitStrategy) DeepCopy() *ProdOvercommitStrategy {
	if in == nil {
		return nil
	}
	out := new(ProdOvercommitStrategy)
	in.DeepCopyInto(out)
	return out
}
