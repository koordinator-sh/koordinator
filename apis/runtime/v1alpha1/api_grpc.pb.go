...
type RuntimeHookServiceClient interface {
	...
	PreRunPodSandboxHook(ctx context.Context, in *RunPodSandboxHookRequest, opts ...grpc.CallOption) (*RunPodSandboxHookResponse, error)
...
func (c *runtimeHookServiceClient) PreRunPodSandboxHook(ctx context.Context, in *RunPodSandboxHookRequest, opts ...grpc.CallOption) (*RunPodSandboxHookResponse, error) {
	out := new(RunPodSandboxHookResponse)
...
type RuntimeHookServiceServer interface {
	...
	// and Original RunPodSandboxRequest generating a new RunPodSandboxRequest to transfer to backend runtime engine.
	// RuntimeHookServer should ensure the correct operations basing on RunPodSandboxHookRequest.
	PreRunPodSandboxHook(context.Context, *RunPodSandboxHookRequest) (*RunPodSandboxHookResponse, error)
	// PreStartContainerHook calls RuntimeHookServer before container starting, RuntimeHookServer could do some
	// resource adjustments before container launching.
...
func (UnimplementedRuntimeHookServiceServer) PreRunPodSandboxHook(context.Context, *RunPodSandboxHookRequest) (*RunPodSandboxHookResponse, error) {
...
func _RuntimeHookService_PreRunPodSandboxHook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunPodSandboxHookRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuntimeHookServiceServer).PreRunPodSandboxHook(ctx, req.(*RunPodSandboxHookRequest))
	}
