...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*GangArgs)(nil), (*config.GangArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GangArgs_To_config_GangArgs(a.(*GangArgs), b.(*config.GangArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GangArgs)(nil), (*GangArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GangArgs_To_v1beta2_GangArgs(a.(*config.GangArgs), b.(*GangArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_GangArgs_To_config_GangArgs(in *GangArgs, out *config.GangArgs, s conversion.Scope) error {
	out.DefaultTimeoutSeconds = (*v1.Duration)(unsafe.Pointer(in.DefaultTimeoutSeconds))
	return nil
}

// Convert_v1beta2_GangArgs_To_config_GangArgs is an autogenerated conversion function.
func Convert_v1beta2_GangArgs_To_config_GangArgs(in *GangArgs, out *config.GangArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_GangArgs_To_config_GangArgs(in, out, s)
}

func autoConvert_config_GangArgs_To_v1beta2_GangArgs(in *config.GangArgs, out *GangArgs, s conversion.Scope) error {
	out.DefaultTimeoutSeconds = (*v1.Duration)(unsafe.Pointer(in.DefaultTimeoutSeconds))
	return nil
}

// Convert_config_GangArgs_To_v1beta2_GangArgs is an autogenerated conversion function.
func Convert_config_GangArgs_To_v1beta2_GangArgs(in *config.GangArgs, out *GangArgs, s conversion.Scope) error {
	return autoConvert_config_GangArgs_To_v1beta2_GangArgs(in, out, s)
}
