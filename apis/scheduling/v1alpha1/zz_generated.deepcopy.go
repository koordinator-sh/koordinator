...
func (in *NodeFailedDetail) DeepCopyInto(out *NodeFailedDetail) {
	*out = *in
	out.NodeFailedStatus = in.NodeFailedStatus
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in NodeFailedDetails) DeepCopyInto(out *NodeFailedDetails) {
	{
		in := &in
		*out = make(NodeFailedDetails, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NodeFailedDetail)
...
func (in *NodeFailedStatus) DeepCopy() *NodeFailedStatus {
	if in == nil {
		return nil
	}
	out := new(NodeFailedStatus)
	in.DeepCopyInto(out)
	return out
}
