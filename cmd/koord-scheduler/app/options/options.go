...
func (o *Options) Config(ctx context.Context) (*schedulerappconfig.Config, error) {
	...
	config.KubeConfig.ContentType = "application/vnd.kubernetes.protobuf"
	config.KubeConfig.AcceptContentTypes = "application/vnd.kubernetes.protobuf,application/json"
