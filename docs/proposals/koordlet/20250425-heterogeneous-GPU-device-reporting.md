...
metadata:
  labels:
    ...
    node.koordinator.sh/gpu-model: Tesla-T4 # Ascend910B/Ascend310
    # New label
...
```GO
// NVIDIA Accelerators enables GPU related feature in koordlet. Only Nvidia GPUs supported.
    Accelerators featuregate.Feature = "NvidiaAccelerator"
// Accelerators enables heterogeneous GPU devices reporting.
