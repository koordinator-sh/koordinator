...
require (
	...
	k8s.io/cloud-provider v0.35.6 // indirect
	k8s.io/controller-manager v0.35.6 // indirect
	k8s.io/cri-client v0.35.6 // indirect
	k8s.io/csi-translation-lib v0.35.6 // indirect
	...
	k8s.io/mount-utils v0.35.6 // indirect
