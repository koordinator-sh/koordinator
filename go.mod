...
require (
	...
	k8s.io/gengo v0.0.0-20240326000052-a8d123592b5a // indirect
)
...
replace (
	...
	github.com/koordinator-sh/scheduler-plugins => gitlab.alibaba-inc.com/koordinator-sh/scheduler-plugins v0.0.0-20250427131649-7be58290c467
	...
	k8s.io/kubernetes => gitlab.alibaba-inc.com/koordinator-sh/kubernetes v1.28.7-internal.8
