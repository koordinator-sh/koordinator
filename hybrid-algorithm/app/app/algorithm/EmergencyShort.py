...
# ================== 参数 ==================
INPUT_DIR = "/root/autodl-tmp/Model 5"  # 原始数据目录（多文件，每行一个JSON）
CHECK_FILE_COUNT = 1  # 1小时=12个文件（按你数据5分钟一文件）,输入4小时数据

OUTPUT_JSONL = "/root/autodl-tmp/BurstData/performance_with_resource_metrics_with_burst.jsonl"
OUTPUT_CSV = "/root/autodl-tmp/BurstData/pod_burst_timestamps.csv"
# ==========================================
