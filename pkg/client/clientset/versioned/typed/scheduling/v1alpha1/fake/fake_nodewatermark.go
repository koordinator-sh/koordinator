...
var nodewatermarksKind = v1alpha1.SchemeGroupVersion.WithKind("NodeWatermark")
...
func (c *FakeNodeWatermarks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.NodeWatermark, err error) {
	...
	return obj.(*v1alpha1.NodeWatermark), err
}
...
func (c *FakeNodeWatermarks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.NodeWatermarkList, err error) {
	...
	list := &v1alpha1.NodeWatermarkList{ListMeta: obj.(*v1alpha1.NodeWatermarkList).ListMeta}
	for _, item := range obj.(*v1alpha1.NodeWatermarkList).Items {
