...
import (
	v1alpha1 "github.com/koordinator-sh/koordinator/pkg/client/clientset/versioned/typed/scheduling/v1alpha1"
...
func (c *FakeSchedulingV1alpha1) NodeWatermarks() v1alpha1.NodeWatermarkInterface {
	return &FakeNodeWatermarks{c}
}
