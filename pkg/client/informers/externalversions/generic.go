...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case schedulingv1alpha1.SchemeGroupVersion.WithResource("nodewatermarks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1alpha1().NodeWatermarks().Informer()}, nil
