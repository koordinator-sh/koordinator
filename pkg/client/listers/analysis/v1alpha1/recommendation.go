...
type RecommendationLister interface {
	...
	List(selector labels.Selector) (ret []*analysisv1alpha1.Recommendation, err error)
...
type recommendationLister struct {
	listers.ResourceIndexer[*analysisv1alpha1.Recommendation]
}
...
type RecommendationNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*analysisv1alpha1.Recommendation, error)
