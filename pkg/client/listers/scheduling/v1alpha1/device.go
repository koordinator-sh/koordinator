...
type DeviceLister interface {
	...
	List(selector labels.Selector) (ret []*schedulingv1alpha1.Device, err error)
	// Get retrieves the Device from the index for a given name.
	// Objects returned here must be treated as read-only.
	Get(name string) (*schedulingv1alpha1.Device, error)
	DeviceListerExpansion
}

// deviceLister implements the DeviceLister interface.
type deviceLister struct {
	listers.ResourceIndexer[*schedulingv1alpha1.Device]
}
