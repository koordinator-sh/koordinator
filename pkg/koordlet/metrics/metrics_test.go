...
func TestCommonCollectors(t *testing.T) {
	...
	t.Run("test not panic", func(t *testing.T) {
		...
		RecordNodeUsedMemory(float64(2048))
		...
		RecordPodCPUThrottledRatio(testingPod.Namespace, testingPod.Name, 0.5)
		RecordContainerCPUThrottledRatio(testingPod.Namespace, testingPod.Name, testingContainer.ContainerID, testingContainer.Name, 0.5)
