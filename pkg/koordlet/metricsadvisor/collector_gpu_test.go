	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				deviceCount: 1,
				devices: []*device{
					{Minor: 0, DeviceUUID: "test-device1", TotalMemory: 8000},
				},
				processesMetrics: map[uint32][]*rawGPUMetric{
		...
		},
		{
			...
			fields: fields{
				...
				devices: []*device{
					{Minor: 0, DeviceUUID: "test-device1", TotalMemory: 8000},
					{Minor: 1, DeviceUUID: "test-device2", TotalMemory: 9000},
				},
				processesMetrics: map[uint32][]*rawGPUMetric{
			...
			want: []metriccache.GPUMetric{
				...
				},
				{
					...
					TotalMemory: *resource.NewQuantity(9000, resource.BinarySI),
				},
			},
		},
		{
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				deviceCount: 1,
				devices: []*device{
					{Minor: 0, DeviceUUID: "test-device1", TotalMemory: 14000},
				},
				processesMetrics: map[uint32][]*rawGPUMetric{
					122: {{SMUtil: 70, MemoryUsed: 1500}},
		...
		},
		{
			...
			fields: fields{
				...
				devices: []*device{
					{Minor: 0, DeviceUUID: "test-device1", TotalMemory: 14000},
					{Minor: 1, DeviceUUID: "test-device2", TotalMemory: 24000},
				},
				processesMetrics: map[uint32][]*rawGPUMetric{
					122: {{SMUtil: 70, MemoryUsed: 1500}, nil},
					222: {nil, {SMUtil: 50, MemoryUsed: 1000}},
			...
			want: []metriccache.GPUMetric{
				...
				},
				{
					...
					SMUtil:      50,
					MemoryUsed:  *resource.NewQuantity(1000, resource.BinarySI),
					TotalMemory: *resource.NewQuantity(24000, resource.BinarySI),
				},
			},
		},
		{
	...
	}{
		{
			...
			fields: fields{
				gpuDeviceManager: &gpuDeviceManager{
					deviceCount: 2,
					devices: []*device{
						{Minor: 0, DeviceUUID: "12", TotalMemory: 14000},
						{Minor: 1, DeviceUUID: "23", TotalMemory: 24000},
					},
					processesMetrics: map[uint32][]*rawGPUMetric{
						122: {{SMUtil: 70, MemoryUsed: 1500}, {SMUtil: 50, MemoryUsed: 1000}},
						222: {{SMUtil: 10, MemoryUsed: 1000}, {SMUtil: 40, MemoryUsed: 3000}},
