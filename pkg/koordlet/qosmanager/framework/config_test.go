...
func Test_NewDefaultConfig(t *testing.T) {
	expectConfig := &Config{
		...
		EvictByCopilotEndPoint:      sysutil.Conf.VarRunRootDir + "/yarn-copilot/yarn-copilot.sock",
...
func Test_InitFlags(t *testing.T) {
	cmdArgs := []string{
		...
		"--evict-by-copilot-endpoint=" + sysutil.Conf.VarRunRootDir + "/yarn-copilot/yarn-copilot.sock",
	}
