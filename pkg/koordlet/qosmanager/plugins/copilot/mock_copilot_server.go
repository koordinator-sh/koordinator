...
func (y *YarnCopilotServer) KillContainersByResource(ctx *gin.Context) {
	...
	releasedResourceList := v1.ResourceList{
		extension.BatchCPU:    *resource.NewQuantity(needReleasedCpu, resource.DecimalSI),
		extension.BatchMemory: *resource.NewQuantity(needReleasedMemory, resource.BinarySI),
	}
