...
func Test_generateConfigCheck(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectErr: fmt.Errorf("unknown feature: xxx"),
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func Test_calculateReleaseByAllocatableThresholdPercent(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectRelease: corev1.ResourceList{
				apiext.BatchMemory: *resource.NewQuantity(16106127360, resource.BinarySI),
			},
		...
		},
		{
			...
			expectRelease: corev1.ResourceList{
				apiext.BatchMemory: *resource.NewQuantity(16106127360, resource.BinarySI),
				apiext.MidMemory:   *resource.NewQuantity(16106127360, resource.BinarySI),
			},
