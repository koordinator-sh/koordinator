...
func applyPodBECPULimitIfSpecified(podMeta *statesinformer.PodMeta) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Reason(reason.UpdateCPU).Message("set cfs_quota to %v", targetCFSQuota).Do()
...
func applyContainerBECPULimitIfSpecified(podMeta *statesinformer.PodMeta, container *corev1.Container, containerStatus *corev1.ContainerStatus) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Container(container.Name).Reason(reason.UpdateCPU).Message("set cfs_quota to %v", targetCFSQuota).Do()
...
func applyPodBECPURequestIfSpecified(podMeta *statesinformer.PodMeta) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Reason(reason.UpdateCPU).Message("set cfs_shares to %v", targetCPUShare).Do()
...
func applyContainerBECPUShareIfSpecified(podMeta *statesinformer.PodMeta, container *corev1.Container, containerStatus *corev1.ContainerStatus) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Container(container.Name).Reason(reason.UpdateCPU).Message("set cfs_shares to %v", targetCPUShare).Do()
...
func applyPodBEMemLimitIfSpecified(podMeta *statesinformer.PodMeta) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Reason(reason.UpdateMemory).Message("set memory.limits to %v", memoryLimit).Do()
...
func applyContainerBEMemLimitIfSpecified(podMeta *statesinformer.PodMeta, container *corev1.Container, containerStatus *corev1.ContainerStatus) error {
	...
	_ = audit.V(2).Pod(podMeta.Pod.Namespace, podMeta.Pod.Name).Container(container.Name).Reason(reason.UpdateMemory).Message("set memory.limits to %v", memoryLimit).Do()
