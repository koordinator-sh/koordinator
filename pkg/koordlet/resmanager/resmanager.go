...
type resmanager struct {
	...
	nodeSLOLister                 listerbeta1.NodeSLOLister
...
func newNodeSLOInformer(client clientsetbeta1.Interface, nodeName string) cache.SharedIndexInformer {
...
func NewResManager(cfg *Config, schema *apiruntime.Scheme, kubeClient clientset.Interface, crdClient *clientsetbeta1.Clientset, nodeName string,
	...
	r := &resmanager{
		...
		nodeSLOLister:                 listerbeta1.NewNodeSLOLister(informer.GetIndexer()),
