...
func GetCgroupUpdater(resourceType sysutil.ResourceType, parentDir string, value string) (ResourceUpdater, error) {
	return DefaultCgroupUpdaterFactory.New(resourceType, parentDir, value)
}
