...
func Test_mergeNodeSLOSpec(t *testing.T) {
	testingCustomNodeSLOSpec := slov1alpha1.NodeSLOSpec{
		ResourceUsedThresholdWithBE: &slov1alpha1.ResourceThresholdStrategy{
			CPUSuppressThresholdPercent: ptr.To[int64](80),
		},
		...
		SystemStrategy: &slov1alpha1.SystemStrategy{
			WatermarkScaleFactor: ptr.To[int64](200),
		},
	}
			...
			field: field{
				nodeSLO: &slov1alpha1.NodeSLO{
					Spec: slov1alpha1.NodeSLOSpec{
						ResourceUsedThresholdWithBE: &slov1alpha1.ResourceThresholdStrategy{
							CPUSuppressThresholdPercent: ptr.To[int64](100),
							MemoryEvictThresholdPercent: ptr.To[int64](100),
						},
						ResourceQOSStrategy: &slov1alpha1.ResourceQOSStrategy{
							...
							BEClass: &slov1alpha1.ResourceQOS{
								ResctrlQOS: &slov1alpha1.ResctrlQOSCfg{
									ResctrlQOS: slov1alpha1.ResctrlQOS{
										CATRangeStartPercent: ptr.To[int64](0),
										CATRangeEndPercent:   ptr.To[int64](40),
									},
								},
							},
						},
...
func Test_createNodeSLO(t *testing.T) {
	...
	testingNewNodeSLO.Spec.ResourceQOSStrategy.BEClass = &slov1alpha1.ResourceQOS{
		ResctrlQOS: &slov1alpha1.ResctrlQOSCfg{
			...
			ResctrlQOS: slov1alpha1.ResctrlQOS{
				CATRangeStartPercent: ptr.To[int64](0),
				CATRangeEndPercent:   ptr.To[int64](20),
			},
		},
	}
	...
	testingCreatedNodeSLO.Spec.ResourceUsedThresholdWithBE.Enable = ptr.To[bool](true)
	testingCreatedNodeSLO.Spec.ResourceUsedThresholdWithBE.CPUSuppressThresholdPercent = ptr.To[int64](80)
	...
	testingCreatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.Enable = ptr.To[bool](true)
	testingCreatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.CATRangeStartPercent = ptr.To[int64](0)
	testingCreatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.CATRangeEndPercent = ptr.To[int64](20)
...
func Test_updateNodeSLOSpec(t *testing.T) {
	...
	testingUpdatedNodeSLO.Spec.ResourceUsedThresholdWithBE.Enable = ptr.To[bool](true)
	testingUpdatedNodeSLO.Spec.ResourceUsedThresholdWithBE.CPUSuppressThresholdPercent = ptr.To[int64](80)
	...
	testingUpdatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.Enable = ptr.To[bool](true)
	testingUpdatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.CATRangeStartPercent = ptr.To[int64](0)
	testingUpdatedNodeSLO.Spec.ResourceQOSStrategy.BEClass.ResctrlQOS.CATRangeEndPercent = ptr.To[int64](20)

	r := nodeSLOInformer{
		nodeSLO: &slov1alpha1.NodeSLO{
			Spec: slov1alpha1.NodeSLOSpec{
				ResourceUsedThresholdWithBE: &slov1alpha1.ResourceThresholdStrategy{
					CPUSuppressThresholdPercent: ptr.To[int64](90),
					MemoryEvictThresholdPercent: ptr.To[int64](90),
				},
			},
		},
		callbackRunner: NewCallbackRunner(),
...
func Test_mergeSLOSpecResourceUsedThresholdWithBE(t *testing.T) {
	...
	testingNewSpec := &slov1alpha1.ResourceThresholdStrategy{
		Enable:                      ptr.To[bool](true),
		CPUSuppressThresholdPercent: ptr.To[int64](80),
		MemoryEvictThresholdPercent: ptr.To[int64](75),
	}
...
func Test_mergeSLOSpecResourceQOSStrategy(t *testing.T) {
	...
	testingNewSpec.BEClass.MemoryQOS.WmarkRatio = ptr.To[int64](0)
	...
	testingMergedSpec.BEClass.MemoryQOS.Enable = ptr.To[bool](true)
	testingMergedSpec.BEClass.MemoryQOS.WmarkRatio = ptr.To[int64](90)
...
func Test_mergeNoneResourceQOSIfDisabled(t *testing.T) {
	...
	testLSMemQOSEnabled.LSClass.MemoryQOS.Enable = ptr.To[bool](true)
	testLSMemQOSEnabledResult := sloconfig.NoneResourceQOSStrategy()
	testLSMemQOSEnabledResult.LSClass.MemoryQOS.Enable = ptr.To[bool](true)
