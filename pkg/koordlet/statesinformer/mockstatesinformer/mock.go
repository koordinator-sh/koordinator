...
// Source: pkg/koordlet/statesinformer/impl/states_informer.go
...
func (mr *MockinformerPluginMockRecorder) HasSynced() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HasSynced", reflect.TypeOf((*MockinformerPlugin)(nil).HasSynced))
}
...
func (mr *MockinformerPluginMockRecorder) Setup(ctx, state interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Setup", reflect.TypeOf((*MockinformerPlugin)(nil).Setup), ctx, state)
}
...
func (mr *MockinformerPluginMockRecorder) Start(stopCh interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockinformerPlugin)(nil).Start), stopCh)
}
