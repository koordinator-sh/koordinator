...
func (m *MockRuntimeServiceClient) ListPodSandboxStats(ctx context.Context, in *v1alpha2.ListPodSandboxStatsRequest, opts ...grpc.CallOption) (*v1alpha2.ListPodSandboxStatsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1alpha2.ListPodSandboxStatsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRuntimeServiceClient) PodSandboxStats(ctx context.Context, in *v1alpha2.PodSandboxStatsRequest, opts ...grpc.CallOption) (*v1alpha2.PodSandboxStatsResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(*v1alpha2.PodSandboxStatsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// ListPodSandboxStats mocks base method.
func (m *MockRuntimeServiceServer) ListPodSandboxStats(arg0 context.Context, arg1 *v1alpha2.ListPodSandboxStatsRequest) (*v1alpha2.ListPodSandboxStatsResponse, error) {
	m.ctrl.T.Helper()
...
// PodSandboxStats mocks base method.
func (m *MockRuntimeServiceServer) PodSandboxStats(arg0 context.Context, arg1 *v1alpha2.PodSandboxStatsRequest) (*v1alpha2.PodSandboxStatsResponse, error) {
	m.ctrl.T.Helper()
