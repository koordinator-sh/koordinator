...
type ReservationArgs struct {
	...
	// key matches one of the configured prefixes or exact keys can quickly
...
type ScheduleAdmissionArgs struct {
	...
	EnablePrefixMatch *bool `json:"enablePrefixMatch,omitempty"`
}
...
type DefaultPreBindArgs struct {
	...
	RetryInitialBackoff *metav1.Duration `json:"retryInitialBackoff,omitempty"`
	// RetryMaxBackoff caps the backoff duration between retry attempts.
	RetryMaxBackoff *metav1.Duration `json:"retryMaxBackoff,omitempty"`
}
