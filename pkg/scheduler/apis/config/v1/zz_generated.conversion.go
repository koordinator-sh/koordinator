...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*PodTypeArgs)(nil), (*config.PodTypeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_PodTypeArgs_To_config_PodTypeArgs(a.(*PodTypeArgs), b.(*config.PodTypeArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.PodTypeArgs)(nil), (*PodTypeArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_PodTypeArgs_To_v1_PodTypeArgs(a.(*config.PodTypeArgs), b.(*PodTypeArgs), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1_PodTypeArgs_To_config_PodTypeArgs is an autogenerated conversion function.
func Convert_v1_PodTypeArgs_To_config_PodTypeArgs(in *PodTypeArgs, out *config.PodTypeArgs, s conversion.Scope) error {
	return autoConvert_v1_PodTypeArgs_To_config_PodTypeArgs(in, out, s)
}
...
// Convert_config_PodTypeArgs_To_v1_PodTypeArgs is an autogenerated conversion function.
func Convert_config_PodTypeArgs_To_v1_PodTypeArgs(in *config.PodTypeArgs, out *PodTypeArgs, s conversion.Scope) error {
	return autoConvert_config_PodTypeArgs_To_v1_PodTypeArgs(in, out, s)
}
