...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeCPUAmplificationArgs)(nil), (*config.NodeCPUAmplificationArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_NodeCPUAmplificationArgs_To_config_NodeCPUAmplificationArgs(a.(*NodeCPUAmplificationArgs), b.(*config.NodeCPUAmplificationArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeCPUAmplificationArgs)(nil), (*NodeCPUAmplificationArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeCPUAmplificationArgs_To_v1beta2_NodeCPUAmplificationArgs(a.(*config.NodeCPUAmplificationArgs), b.(*NodeCPUAmplificationArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_NodeCPUAmplificationArgs_To_config_NodeCPUAmplificationArgs(in *NodeCPUAmplificationArgs, out *config.NodeCPUAmplificationArgs, s conversion.Scope) error {
	out.ScoringStrategy = (*config.ScoringStrategy)(unsafe.Pointer(in.ScoringStrategy))
	return nil
}

// Convert_v1beta2_NodeCPUAmplificationArgs_To_config_NodeCPUAmplificationArgs is an autogenerated conversion function.
func Convert_v1beta2_NodeCPUAmplificationArgs_To_config_NodeCPUAmplificationArgs(in *NodeCPUAmplificationArgs, out *config.NodeCPUAmplificationArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_NodeCPUAmplificationArgs_To_config_NodeCPUAmplificationArgs(in, out, s)
}

func autoConvert_config_NodeCPUAmplificationArgs_To_v1beta2_NodeCPUAmplificationArgs(in *config.NodeCPUAmplificationArgs, out *NodeCPUAmplificationArgs, s conversion.Scope) error {
	out.ScoringStrategy = (*ScoringStrategy)(unsafe.Pointer(in.ScoringStrategy))
	return nil
}

// Convert_config_NodeCPUAmplificationArgs_To_v1beta2_NodeCPUAmplificationArgs is an autogenerated conversion function.
func Convert_config_NodeCPUAmplificationArgs_To_v1beta2_NodeCPUAmplificationArgs(in *config.NodeCPUAmplificationArgs, out *NodeCPUAmplificationArgs, s conversion.Scope) error {
	return autoConvert_config_NodeCPUAmplificationArgs_To_v1beta2_NodeCPUAmplificationArgs(in, out, s)
}
