...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NodeCPUAmplificationArgs) DeepCopyInto(out *NodeCPUAmplificationArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.ScoringStrategy != nil {
		in, out := &in.ScoringStrategy, &out.ScoringStrategy
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NodeCPUAmplificationArgs.
func (in *NodeCPUAmplificationArgs) DeepCopy() *NodeCPUAmplificationArgs {
	if in == nil {
		return nil
	}
	out := new(NodeCPUAmplificationArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NodeCPUAmplificationArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
func (in *ScoringStrategy) DeepCopyInto(out *ScoringStrategy) {
	*out = *in
	if in.Resources != nil {
		...
		*out = make([]configv1beta2.ResourceSpec, len(*in))
		copy(*out, *in)
	}
	return
}
