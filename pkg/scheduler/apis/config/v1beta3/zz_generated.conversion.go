...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CustomLimiterConf)(nil), (*config.CustomLimiterConf)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta3_CustomLimiterConf_To_config_CustomLimiterConf(a.(*CustomLimiterConf), b.(*config.CustomLimiterConf), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CustomLimiterConf)(nil), (*CustomLimiterConf)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CustomLimiterConf_To_v1beta3_CustomLimiterConf(a.(*config.CustomLimiterConf), b.(*CustomLimiterConf), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta3_CustomLimiterConf_To_config_CustomLimiterConf(in *CustomLimiterConf, out *config.CustomLimiterConf, s conversion.Scope) error {
	out.FactoryKey = in.FactoryKey
	out.FactoryArgs = in.FactoryArgs
	return nil
}

// Convert_v1beta3_CustomLimiterConf_To_config_CustomLimiterConf is an autogenerated conversion function.
func Convert_v1beta3_CustomLimiterConf_To_config_CustomLimiterConf(in *CustomLimiterConf, out *config.CustomLimiterConf, s conversion.Scope) error {
	return autoConvert_v1beta3_CustomLimiterConf_To_config_CustomLimiterConf(in, out, s)
}

func autoConvert_config_CustomLimiterConf_To_v1beta3_CustomLimiterConf(in *config.CustomLimiterConf, out *CustomLimiterConf, s conversion.Scope) error {
	out.FactoryKey = in.FactoryKey
	out.FactoryArgs = in.FactoryArgs
	return nil
}

// Convert_config_CustomLimiterConf_To_v1beta3_CustomLimiterConf is an autogenerated conversion function.
func Convert_config_CustomLimiterConf_To_v1beta3_CustomLimiterConf(in *config.CustomLimiterConf, out *CustomLimiterConf, s conversion.Scope) error {
	return autoConvert_config_CustomLimiterConf_To_v1beta3_CustomLimiterConf(in, out, s)
}
...
func autoConvert_v1beta3_ElasticQuotaArgs_To_config_ElasticQuotaArgs(in *ElasticQuotaArgs, out *config.ElasticQuotaArgs, s conversion.Scope) error {
	...
	out.CustomLimiters = *(*map[string]config.CustomLimiterConf)(unsafe.Pointer(&in.CustomLimiters))
	return nil
}
...
func autoConvert_config_ElasticQuotaArgs_To_v1beta3_ElasticQuotaArgs(in *config.ElasticQuotaArgs, out *ElasticQuotaArgs, s conversion.Scope) error {
	...
	out.CustomLimiters = *(*map[string]CustomLimiterConf)(unsafe.Pointer(&in.CustomLimiters))
	return nil
}
