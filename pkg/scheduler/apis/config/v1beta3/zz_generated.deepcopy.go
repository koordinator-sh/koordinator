...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomLimiterConf) DeepCopyInto(out *CustomLimiterConf) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomLimiterConf.
func (in *CustomLimiterConf) DeepCopy() *CustomLimiterConf {
	if in == nil {
		return nil
	}
	out := new(CustomLimiterConf)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ElasticQuotaArgs) DeepCopyInto(out *ElasticQuotaArgs) {
	*out = *in
	...
	if in.CustomLimiters != nil {
		in, out := &in.CustomLimiters, &out.CustomLimiters
		*out = make(map[string]CustomLimiterConf, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
