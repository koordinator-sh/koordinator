...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LimitAwareArgs) DeepCopyInto(out *LimitAwareArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.ScoringResourceWeights != nil {
		in, out := &in.ScoringResourceWeights, &out.ScoringResourceWeights
		*out = make(map[corev1.ResourceName]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.DefaultLimitToAllocatableRatio != nil {
		in, out := &in.DefaultLimitToAllocatableRatio, &out.DefaultLimitToAllocatableRatio
		*out = make(extension.LimitToAllocatableRatio, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LimitAwareArgs.
func (in *LimitAwareArgs) DeepCopy() *LimitAwareArgs {
	if in == nil {
		return nil
	}
	out := new(LimitAwareArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LimitAwareArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
