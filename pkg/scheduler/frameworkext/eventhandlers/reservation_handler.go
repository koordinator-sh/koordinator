...
func updateReservation(client koordclientset.Interface, sched *scheduler.Scheduler, schedAdapter frameworkext.Scheduler, oldR, newR *schedulingv1alpha1.Reservation) {
...
func updateReservationInSchedulerCache(client koordclientset.Interface, sched frameworkext.Scheduler, oldR, newR *schedulingv1alpha1.Reservation) {
