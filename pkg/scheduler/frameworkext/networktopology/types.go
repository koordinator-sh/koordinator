...
type TopologyState struct {
	...
	MustGatheredTopologyNode []*TreeNode
}
...
func GetMustGatherLayer(spec *extension.NetworkTopologySpec, isLayerAncestorFunc IsLayerAncestorFunc) schedulingv1alpha1.TopologyLayer {
...
type NodeToScore map[string]int

type DimensionalNodeToScore struct {
	Dimension        string
	PreferLowerScore bool
	NodeToScore      NodeToScore
}
