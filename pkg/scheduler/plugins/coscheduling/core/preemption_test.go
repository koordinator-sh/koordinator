...
func Test_preemptionEvaluatorImpl_preempt(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantPreemptionState: &JobPreemptionState{
				...
				reason:                        "preemption already attempted by default/trigger-pod-1 with message",
		...
		},
		{
			...
			wantPreemptionState: &JobPreemptionState{
				triggerPodKey:                 "default/pending-pod-1",
				preemptorKey:                  "default/gangA,default/gangB",
				reason:                        "0/2 nodes are available: 2 Preemption is not helpful for scheduling.",
				clearNominatedNodeFailedMsg:   map[string]string{},
				terminatingPodOnNominatedNode: map[string]string{},
			},
		...
		},
		{
			...
			wantPreemptionState: &JobPreemptionState{
				triggerPodKey:                 "default/pending-pod-1",
				preemptorKey:                  "default/gangA,default/gangB",
				reason:                        "0/2 nodes are available: 2 no potential victims.",
				clearNominatedNodeFailedMsg:   map[string]string{},
				terminatingPodOnNominatedNode: map[string]string{},
			},
		...
		},
		{
			...
			wantPreemptionState: &JobPreemptionState{
				triggerPodKey:                 "default/pending-pod-1",
				preemptorKey:                  "default/gangA,default/gangB",
				reason:                        "preempt success, alreadyWaitingForBound: 0/2",
				clearNominatedNodeFailedMsg:   map[string]string{},
				terminatingPodOnNominatedNode: map[string]string{},
		...
		},
		{
			...
			wantPreemptionState: &JobPreemptionState{
				triggerPodKey:                 "default/pending-pod-1",
				preemptorKey:                  "default/gangA,default/gangB",
				reason:                        "preempt success, alreadyWaitingForBound: 1/2",
				clearNominatedNodeFailedMsg:   map[string]string{},
				terminatingPodOnNominatedNode: map[string]string{},
				statusMap:                     map[string]*framework.Status{},
				podToNominatedNode: map[string]string{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			preemptionState.durationOfCycleStateClone = 0
			preemptionState.durationOfNodeInfoClone = 0
