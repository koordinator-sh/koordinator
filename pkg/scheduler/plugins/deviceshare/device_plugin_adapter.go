...
// ensureAnnotations returns the annotations of the object, initializing them first if they are nil,
// so that callers can safely write into the returned map.
...
// ensureLabels returns the labels of the object, initializing them first if they are nil,
// so that callers can safely write into the returned map.
