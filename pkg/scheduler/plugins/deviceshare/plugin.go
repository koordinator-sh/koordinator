...
func (p *Plugin) Filter(ctx context.Context, cycleState *framework.CycleState, pod *corev1.Pod, nodeInfo *framework.NodeInfo) *framework.Status {
	...
	if state.gpuRequirements != nil && state.gpuRequirements.gpuShared &&
		pod.Labels != nil && pod.Labels[apiext.LabelGPUIsolationProvider] == string(apiext.GPUIsolationProviderHAMICore) &&
		(node.Labels == nil || node.Labels[apiext.LabelGPUIsolationProvider] != string(apiext.GPUIsolationProviderHAMICore)) {
