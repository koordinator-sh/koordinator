...
func parseGPURequirements(pod *corev1.Pod, podRequests map[schedulingv1alpha1.DeviceType]corev1.ResourceList, gpuHints *apiext.DeviceHint) (*GPURequirements, error) {
	...
	gpuRequirements := &GPURequirements{
		...
		gpuShared:              isShared,
		honorGPUPartition:      gpuPartitionSpec.AllocatePolicy == apiext.GPUPartitionAllocatePolicyHonor,
		gpuLinkType:            gpuPartitionSpec.GPULinkType,
		rindAllReduceBandwidth: gpuPartitionSpec.RingAllReduceBandwidth,
	}
	if gpuHints != nil {
