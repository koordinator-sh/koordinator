...
func TestGroupQuotaManager_UpdateQuotaInternalAndRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test1", request, request, true)
...
func TestGroupQuotaManager_UpdateQuotaDeltaRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test2", request, request, true)
	runtime = gqm.RefreshRuntime("test1")
...
func TestGroupQuotaManager_NotAllowLentResource_2(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test-child1", request, request, true)
	...
	gqm.updateGroupDeltaRequestNoLock("test-child1", request2, request2, true)
...
func TestGroupQuotaManager_UpdateQuotaRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test1", request, newRequest, true)
	runtime = gqm.RefreshRuntime("test1")
	assert.Equal(t, deltaRes, runtime)
...
func TestGroupQuotaManager_UpdateGroupDeltaUsedAndNonPreemptibleUsed(t *testing.T) {
	...
	gqm.updateGroupDeltaUsedNoLock("test1", used, nonPreemptibleUsed, true)
	quotaInfo := gqm.GetQuotaInfoByName("test1")
	assert.NotNil(t, quotaInfo)
...
func TestGroupQuotaManager_MultiUpdateQuotaRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("a-123", request, request, true)
...
func TestGroupQuotaManager_MultiUpdateQuotaRequest_WithScaledMinQuota1(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("a", request, request, true)
	gqm.updateGroupDeltaRequestNoLock("b", request, request, true)
	gqm.updateGroupDeltaRequestNoLock("c", request, request, true)
...
func TestGroupQuotaManager_MultiUpdateQuotaRequest_WithScaledMinQuota2(t *testing.T) {
	...
	request := createResourceList(200, 200*GigaByte)
	gqm.updateGroupDeltaRequestNoLock("a", request, request, true)
	gqm.updateGroupDeltaRequestNoLock("b", createResourceList(0, 0), createResourceList(0, 0), true)
	gqm.updateGroupDeltaRequestNoLock("c", request, request, true)
...
func TestGroupQuotaManager_MultiUpdateQuotaUsedAndNonPreemptibleUsed(t *testing.T) {
	...
	gqm.updateGroupDeltaUsedNoLock("test1-sub1", used, nonPreemptibleUsed, true)
...
func TestGroupQuotaManager_MultiUpdateQuotaRequestAndNonPreemptibleRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test1-sub1-1", request, nonPreemptibleRequest, true)
...
func TestGroupQuotaManager_UpdateQuotaParentName(t *testing.T) {
	...
	request := createResourceList(60, 100*GigaByte)
	gqm.updateGroupDeltaRequestNoLock("a-123", request, request, true)
	gqm.updateGroupDeltaUsedNoLock("a-123", request, createResourceList(0, 0), true)
	...
	gqm.updateGroupDeltaRequestNoLock("test2-a", request, request, true)
	gqm.updateGroupDeltaUsedNoLock("test2-a", request, createResourceList(0, 0), true)
...
func TestGroupQuotaManager_UpdateClusterTotalResource(t *testing.T) {
	...
	gqm.updateGroupDeltaUsedNoLock(extension.SystemQuotaName, sysUsed, createResourceList(0, 0), true)
	...
	// 80, 480
	gqm.updateGroupDeltaUsedNoLock(extension.SystemQuotaName, createResourceList(10, 30), createResourceList(0, 0), true)
	...
	gqm.updateGroupDeltaUsedNoLock(extension.DefaultQuotaName, defaultUsed, createResourceList(0, 0), true)
...
func TestGroupQuotaManager_MultiChildMaxGreaterParentMax_MaxGreaterThanTotalRes(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("test1-sub1", request, request, true)
...
func TestGroupQuotaManager_RefreshAndGetRuntimeQuota_UpdateQuota(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock("1", createResourceList(5, 5), createResourceList(5, 5), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(5, 5), createResourceList(5, 5), true)
	...
	gqm.updateGroupDeltaRequestNoLock("1", createResourceList(25, 25), createResourceList(25, 25), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(25, 25), createResourceList(25, 25), true)
...
func TestGroupQuotaManager_UpdateOneGroupMaxQuota_UpdateQuota(t *testing.T) {
	...
	// case1: min < req < max
	gqm.updateGroupDeltaRequestNoLock("1", createResourceList(35, 35), createResourceList(35, 35), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(35, 35), createResourceList(35, 35), true)
...
func TestGroupQuotaManager_UpdateOneGroupMinQuota_UpdateQuota(t *testing.T) {
	...
	// case1:  min < req < max
	gqm.updateGroupDeltaRequestNoLock("1", createResourceList(15, 15), createResourceList(15, 15), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(15, 15), createResourceList(15, 15), true)
	...
	gqm.UpdateQuota(qi1, false)
	gqm.UpdateQuota(qi2, false)
	gqm.updateGroupDeltaRequestNoLock("1", createResourceList(100, 100), createResourceList(100, 100), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(100, 100), createResourceList(100, 100), true)
...
func BenchmarkGroupQuotaManager_RefreshRuntime(b *testing.B) {
	...
	for j := 0; j < 2000; j++ {
		...
		gqm.updateGroupDeltaRequestNoLock(fmt.Sprintf("%v", j), request, request, true)
	}
...
func TestGroupQuotaManager_UpdateRootQuotaUsed(t *testing.T) {
	...
	gqm.updateGroupDeltaUsedNoLock(extension.SystemQuotaName, sysUsed, createResourceList(0, 0), true)
	gqm.updateGroupDeltaRequestNoLock(extension.SystemQuotaName, sysUsed, sysUsed, true)
	assert.Equal(t, sysUsed, gqm.GetQuotaInfoByName(extension.SystemQuotaName).GetUsed())
	...
	gqm.updateGroupDeltaUsedNoLock(extension.DefaultQuotaName, defaultUsed, createResourceList(0, 0), true)
	gqm.updateGroupDeltaRequestNoLock(extension.DefaultQuotaName, defaultUsed, defaultUsed, true)
	assert.Equal(t, defaultUsed, gqm.GetQuotaInfoByName(extension.DefaultQuotaName).GetUsed())
	...
	gqm.updateGroupDeltaUsedNoLock("2", createResourceList(5, 5), createResourceList(0, 0), true)
	gqm.updateGroupDeltaUsedNoLock("3", createResourceList(7, 5), createResourceList(0, 0), true)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(0, 0), createResourceList(5, 5), true)
	gqm.updateGroupDeltaRequestNoLock("3", createResourceList(0, 0), createResourceList(7, 5), true)
...
func TestGroupQuotaManager_UpdateRootQuotaRequest(t *testing.T) {
	...
	gqm.updateGroupDeltaRequestNoLock(extension.SystemQuotaName, sysRequest, sysRequest, true)
	...
	gqm.updateGroupDeltaRequestNoLock(extension.DefaultQuotaName, defaultRequest, defaultRequest, true)
	...
	gqm.UpdateQuota(qi3, false)
	gqm.updateGroupDeltaRequestNoLock("2", createResourceList(5, 5), createResourceList(5, 5), true)
	gqm.updateGroupDeltaRequestNoLock("3", createResourceList(7, 5), createResourceList(7, 5), true)
