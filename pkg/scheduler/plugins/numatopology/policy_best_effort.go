...
func (p *bestEffortPolicy) canAdmitPodResult(hint *frameworkext.NUMATopologyHint) bool {
	return true
}

func (p *bestEffortPolicy) Merge(providersHints []map[string][]frameworkext.NUMATopologyHint) (frameworkext.NUMATopologyHint, bool) {
