...
//			}
//			got, got1 := h.BeforePreFilter(tt.args.handle, tt.args.cycleState, tt.args.pod)
...
//		skip:         false,
//		matchedCache: newAvailableCache(),
//		unmatched: map[string]corev1.ResourceList{
//			testNodeName: {
//				corev1.ResourceCPU: *resource.NewQuantity(1, resource.DecimalSI),
//			},
//		},
...
//
//			h := NewTransformer()
//			got, got1, got2 := h.BeforeFilter(nil, tt.args.cycleState, tt.args.pod, tt.args.nodeInfo)
//			assert.Equal(t, tt.want, got)
...
func Test_restorePVCRefCounts(t *testing.T) {
	...
	t.Run("test not panic", func(t *testing.T) {
		restorePVCRefCounts(fh, testNodeInfo, normalPod, matchedCache)
