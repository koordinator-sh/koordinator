...
func TestPlugin_Score(t *testing.T) {
	...
	var v1beta2args v1beta3.ScarceResourceAvoidanceArgs
	v1beta2args.Resources = []v1.ResourceName{"nvidia.com/gpu"}

	var scarceResourceAvoidanceArgs config.ScarceResourceAvoidanceArgs
	err := v1beta3.Convert_v1beta3_ScarceResourceAvoidanceArgs_To_config_ScarceResourceAvoidanceArgs(&v1beta2args, &scarceResourceAvoidanceArgs, nil)
	...
	p, err := proxyNew(&scarceResourceAvoidanceArgs, fh)
	p.Name()
	assert.NotNil(t, p)
	assert.Nil(t, err)
	plug := p.(*Plugin)
