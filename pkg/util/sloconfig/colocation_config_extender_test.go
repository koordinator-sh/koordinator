...
func Test_registerDefaultColocationExtension(t *testing.T) {
	...
	t.Run("test register default colocation extension", func(t *testing.T) {
		...
		expectStr := `{"enable":false,"metricAggregateDurationSeconds":300,"metricReportIntervalSeconds":60,"metricAggregatePolicy":{"durations":["5m0s","10m0s","30m0s"]},"metricMemoryCollectPolicy":"usageWithoutPageCache","cpuReclaimThresholdPercent":60,"cpuReclaimableReservedPercent":0,"cpuCalculatePolicy":"usage","memoryReclaimThresholdPercent":65,"memoryReclaimableReservedPercent":0,"memoryCalculatePolicy":"usage","degradeTimeMinutes":15,"updateTimeThresholdSeconds":300,"resourceDiffThreshold":0.1,"midCPUThresholdPercent":100,"midMemoryThresholdPercent":100,"midUnallocatedPercent":0,"extensions":{"test-ext-key":{"testBoolVal":true}}}`
